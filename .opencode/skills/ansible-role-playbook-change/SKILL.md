...
ansible/
  ...
  inventories/                # mixed: see "Source-of-truth boundaries"
    group_vars/               # hand-maintained
    host_vars/                # hand-maintained
    k3s-nodes.yml, openclaw.yml, llm.yml,        # Terraform-generated
    garage.yml, photon.yml, public-vps.local.yml # Terraform-generated
    all-vms.yml, baremetal.yml, k3s-cluster.yml, # hand-maintained
    public-vps.yml                                # hand-maintained
...
- **`ansible/inventories/` is mixed-source — check the file header before
  editing.** Files whose first non-comment line is
  `THIS FILE IS DYNAMICALLY GENERATED BY TERRAFORM` (`k3s-nodes.yml`,
  `openclaw.yml`, `llm.yml`, `garage.yml`, `photon.yml`,
  `public-vps.local.yml`) are Terraform-owned; hand-editing them is an
  anti-pattern — fix the upstream Terraform root instead. The remaining host
  inventories (`all-vms.yml`, `baremetal.yml`, `k3s-cluster.yml`,
  `public-vps.yml`) and all of `group_vars/` / `host_vars/` are
  hand-maintained; edit them directly in Ansible.
...
- Hand-editing a Terraform-generated file under `ansible/inventories/`
  (`k3s-nodes.yml`, `openclaw.yml`, `llm.yml`, `garage.yml`, `photon.yml`,
  `public-vps.local.yml`) — check the file header; fix upstream Terraform
  instead. Note that `group_vars/`, `host_vars/`, and the hand-maintained
  host inventories ARE editable directly.
